...
export const PARTNERS = [
  ...
  },
  {
    ...
    status: "partner-live",
    tagline: "Verified MiroShark holders can claim a refund-backed MiroShark run credit.",
    audience: "MiroShark holders",
    requirement: "Verify MiroShark holder status",
    emptyCopy: "Connect a wallet holding MiroShark to unlock one refund-backed run credit.",
    links: [
...
export const DEFAULT_PERKS = [
  ...
  },
  {
    ...
    expires: "Partner launch",
    summary: "MiroShark holders can claim one run credit. The x402 call still charges normally, then the affiliate-backed refund path handles the credit.",
    deliverable: "1 refund-backed MiroShark run",
    cta: "Claim credit",
    featured: true,
  },
  {
    ...
    expires: "Partner launch",
    summary: "Wallets holding both MiroShark and ECHO can claim a second refund-backed MiroShark run credit.",
    deliverable: "Second refund-backed MiroShark run",
    cta: "Claim bonus credit",
    featured: true,
  },
];
