...
export const PARTNERS = [
  {
    ...
    links: [
      ...
      { label: "Gauntlet", url: "https://www.builtbyecho.xyz/gauntlet" },
      { label: "BaseScan", url: "https://basescan.org/token/0xA7F63eB41779925803a3EEC30890742571e63Ba3" },
  ...
  },
  {
    ...
    status: "partner-live",
    tagline: "Verified MiroShark holders can claim a MiroShark run credit through Echo perks.",
    audience: "MiroShark holders",
    requirement: "Verify MiroShark holder status",
    emptyCopy: "Connect a wallet holding MiroShark to unlock one MiroShark run credit.",
    links: [
...
export const DEFAULT_PERKS = [
  ...
  },
  {
    ...
    expires: "Ongoing",
    summary: "MiroShark holders can claim one run credit through the standard Echo perks claim flow.",
    deliverable: "1 MiroShark run credit",
    cta: "Claim credit",
    featured: true,
  },
  {
    ...
    expires: "Ongoing",
    summary: "Wallets holding both MiroShark and ECHO can claim a second MiroShark run credit through Echo perks.",
    deliverable: "Second MiroShark run credit",
    cta: "Claim bonus credit",
    featured: true,
  },
];
