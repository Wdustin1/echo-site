...
export const PARTNERS = [
  ...
  },
  {
    ...
    status: "partner-live",
    tagline: "MiroShark holders can claim a premium simulation run, with a second credit for ECHO dual-holders.",
    audience: "MiroShark holders",
    requirement: "Verify MiroShark holder status",
    emptyCopy: "Connect a wallet holding MiroShark to unlock the run credit.",
    links: [
...
export const DEFAULT_PERKS = [
  ...
  },
  {
    ...
    expires: "Partner launch",
    summary: "MiroShark holders can claim one premium MiroShark simulation run through Echo Perks.",
    deliverable: "One MiroShark run",
    cta: "Claim run credit",
    featured: true,
  },
  {
    ...
    expires: "Partner launch",
    summary: "Wallets holding both MiroShark and ECHO can claim a second premium MiroShark simulation run.",
    deliverable: "Second MiroShark run",
    cta: "Claim boost credit",
    featured: true,
  },
];
